...
Author:chenhao
Date: Jan 25 ,2017
Description: Use the train_Drop_Delete_Log_Poly.csv and PolynomialFeature in LGB model
'''
...
train = pd.read_csv(data_path + 'train_Drop_Delete_Log_Poly_Ratio.csv', encoding='gb2312')
test = pd.read_csv(data_path + 'test_Drop_Delete_Log_Poly_Ratio.csv', encoding='gb2312')
